...
export const openBatteryOptimizationSettings = async () => {
  try {
    if (Platform.OS === "android") {
      ...
      try {
        // More direct intent to battery optimization settings
...
export const getBatteryOptimizationWarningText = (): string => {
  return `ℹ️ To ensure timely notifications, please disable battery optimization for this app in your device's settings. This setting can sometimes delay background notifications.`;
};
